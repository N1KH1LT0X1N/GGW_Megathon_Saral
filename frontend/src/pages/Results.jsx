...
const Info = ({ label, value }) => (
  <div className="mb-4 sm:mb-0">
    <label className="text-sm font-sans font-medium text-neutral-300 block mb-1">
      {label}
    </label>
    <p className="text-neutral-100 font-sans break-words text-sm sm:text-base">
      {value}
    </p>
  </div>
);
...
const DownloadCard = ({ 
  ...
  <motion.div
    ...
    className="bg-neutral-900 rounded-md p-4 sm:p-6 border border-neutral-800 shadow-sm"
  >
    <div className="flex items-start space-x-3 sm:space-x-4">
      <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gray-900 dark:bg-gray-900 rounded-md flex items-center justify-center flex-shrink-0">
        <Icon className="w-5 h-5 sm:w-6 sm:h-6 text-neutral-200" />
      </div>
      <div className="flex-1 min-w-0">
        <h3 className="text-base sm:text-lg font-sans font-semibold text-gray-200 dark:text-gray-100 mb-2">
          {title}
        </h3>
        <p className="text-neutral-300 mb-4 font-sans text-sm">
          {description}
        </p>
...
const SocialShare = ({ paperId, title }) => {
  ...
  return (
    <motion.div 
      initial={{ opacity: 0, y: 20 }} 
      animate={{ opacity: 1, y: 0 }}
      className="bg-neutral-800 dark:bg-neutral-800 rounded-md p-4 sm:p-6 border border-neutral-700 dark:border-neutral-700 shadow-sm"
    >
      <div className="text-center">
        <h3 className="text-lg font-sans font-semibold text-gray-100 dark:text-gray-100 mb-2">
          Share Your Presentation
        </h3>
        <p className="text-gray-400 dark:text-gray-400 font-sans text-sm mb-4">
        ...
        <div className="flex flex-wrap justify-center gap-3 sm:gap-4">
          {shareLinks.map((link) => (
            <a
              ...
              className={`flex items-center gap-2 px-3 sm:px-4 py-2 rounded-md border border-gray-700 dark:border-gray-700 hover:bg-gray-50/80 dark:hover:bg-gray-700 transition-colors duration-150 ${link.className} text-sm sm:text-base font-sans font-medium`}
  ...
  return (
    <Layout title="" breadcrumbs={breadcrumbs}>
      <div className="max-w-4xl mx-auto space-y-6 sm:space-y-8 px-4 sm:px-6 lg:px-0">
        ...
        >
          <div className="mx-auto w-12 h-12 sm:w-16 sm:h-16 bg-gray-700 dark:bg-gray-700 rounded-full flex items-center justify-center mb-4 sm:mb-6">
            <FiCheckCircle className="w-6 h-6 sm:w-8 sm:h-8 text-gray-300 dark:text-gray-300" />
          </div>
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-sans font-bold text-white dark:text-white mb-3 sm:mb-4">
            🎉 Presentation Complete!
          </h1>
          <p className="text-base sm:text-lg text-gray-400 dark:text-gray-400 font-sans max-w-2xl mx-auto px-4">
        ...
        {metadata && (
          <motion.div 
            initial={{ opacity: 0, y: 20 }} 
            animate={{ opacity: 1, y: 0 }} 
            className="bg-neutral-800 dark:bg-neutral-800 rounded-md p-4 sm:p-6 border border-neutral-200 dark:border-neutral-700 shadow-sm"
          >
            <h2 className="text-lg sm:text-xl font-sans font-semibold text-gray-100 dark:text-gray-100 mb-4">
              Paper Information
            </h2>
        ...
        {videoPath && (
          <motion.div 
            initial={{ opacity: 0, y: 20 }} 
            animate={{ opacity: 1, y: 0 }} 
            className="bg-gray-900 dark:bg-gray-900 rounded-md p-3 sm:p-6 border border-neutral-200 dark:border-neutral-700 shadow-sm"
          >
        ...
        {audioFiles?.length > 0 && (
          <motion.div 
            ...
            className="bg-neutral-800 dark:bg-neutral-800 rounded-md p-4 sm:p-6 border border-neutral-700 dark:border-neutral-700 shadow-sm"
          >
            <h3 className="text-lg font-sans font-semibold text-gray-100 dark:text-gray-100 mb-4">
              Individual Audio Files
            </h3>
            <div className="space-y-3">
              {audioFiles.map((f, i) => (
                <div key={f} className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-3 sm:p-4 bg-neutral-800 dark:border-b dark:bg-neutral-800 rounded-md gap-3 sm:gap-4">
                  <div className="flex items-center space-x-3 min-w-0 flex-1">
                    <div className="w-8 h-8 sm:w-10 sm:h-10 bg-neutral-800 dark:bg-neutral-800 rounded-md flex items-center justify-center flex-shrink-0">
                      <FiMic className="w-4 h-4 sm:w-5 sm:h-5 text-gray-300 dark:text-gray-300" />
                    </div>
                    <div className="min-w-0 flex-1">
                      <p className="font-sans font-medium text-gray-100 dark:text-gray-100 truncate text-sm sm:text-base">
                        {f}
                      </p>
                      <p className="text-xs sm:text-sm font-sans text-gray-400 dark:text-gray-400">
                        Section {i + 1}
                      </p>
                    </div>
                  </div>
