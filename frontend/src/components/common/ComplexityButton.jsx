  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        ...
        className="flex items-center gap-2 px-3 py-2 rounded-lg bg-neutral-900 hover:bg-neutral-800 text-white transition-colors duration-150 min-w-fit whitespace-nowrap"
        title="Content Complexity Level"
      >
        <span className="text-lg flex-shrink-0">{complexityConfig.icon}</span>
